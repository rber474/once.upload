/*! upload 1.0.0 */(()=>{var e,t,n,r,o,i,a,s,u,l,c,f,p,d,h,g,v,y={99190:(e,t,n)=>{"use strict";const r={};let o=!1;void 0===window.__patternslib_container_map&&(window.__patternslib_container_map={});const i=window.__patternslib_container_map;async function a({remote_name:e,exposed_module:t="./main"}){if(i[`${e}-${t}`])return;const a=await async function(e){const t=window[e];return r[e]||(o||(await n.I("default"),o=!0),await t.init(n.S.default),r[e]=!0),t}(e),s=(await a.get(t))();return i[`${e}-${t}`]=!0,console.debug(`Patternslib Module Federation: Loaded and initialized bundle "${e}".`),s}var s;s=function(){const e=Object.keys(window).filter((e=>0===e.indexOf("__patternslib_mf__")));for(const t of e)a({remote_name:t});document.dispatchEvent(new Event("patternslib__mf--loaded",{bubbles:!0,cancelable:!1}))},"complete"===document.readyState||"interactive"===document.readyState?setTimeout(s,1):document.addEventListener("DOMContentLoaded",s),Promise.all([n.e(617),n.e(929)]).then(n.bind(n,75729))},19755:function(e,t){var n;
/*!
