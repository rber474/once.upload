...
#
#  $ bin/test -s once.upload -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src once.upload.testing.ONCE_UPLOAD_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/once/upload/tests/robot/test_example.robot
#
